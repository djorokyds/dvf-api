...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .recommande-box { margin: 0 14px 10px; background: #1f1f1f; border-radius: 12px; border: #888; padding: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border-left: 4px solid #C38F5A; }
