...
export default async function handler(req, res) {
  ...
  try {
    ...
    let url = `${SUPABASE_URL}/rest/v1/transactions?code_postal=eq.${code_postal}&select=date_mutation,type_bien,surface,valeur_fonciere,prix_m2,nb_pieces,prix_median_section,section_cadastrale,cle_section,latitude,longitude&order=date_mutation.desc.nullslast&limit=500`;
