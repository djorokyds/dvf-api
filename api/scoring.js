  ...
  <div class="container">
    <div class="gauge-wrap">
      <svg viewBox="0 0 260 160">
          <!-- Rouge 60° -->
          <path d="M38,148 A92,92 0 0 1 92,60" fill="none" stroke="#e05565" stroke-width="20" stroke-linecap="round"/>
          <!-- Gris 60° -->
          <path d="M100,60 A92,92 0 0 1 160,60" fill="none" stroke="#555555" stroke-width="20" stroke-linecap="round"/>
          <!-- Vert 60° -->
          <path d="M167,60 A92,92 0 0 1 222,148" fill="none" stroke="#3dbf8a" stroke-width="20" stroke-linecap="round"/>
        <!-- Aiguille -->
