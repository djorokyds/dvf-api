...
<body>
  ...
  // Fusionner les années des deux séries
  ...
  <div class="chart-box">
    ...
    <div class="legend">
      <div class="legend-item">
        <div class="legend-dot" style="background:#8e44ad;height:3px;width:24px;"></div>
        Section ${section_cadastrale || 'N/A'}
      </div>
      <div class="legend-item">
        <div class="legend-dot" style="background:#3498db;height:3px;width:24px;border-top:2px dashed #3498db;"></div>
        ${ville}
      </div>
    </div>
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Étape 3 : Transactions de la section (toutes les années)
    ...
    // Étape 4 : Transactions de la ville entière (toutes les années)
